...
async def strt(event):
    await event.reply(f"Hey❤️. I'm a 💐force subscribe bot💐 made specially for ❤️@{channel}!\n\nCheckout ❤️@The_SHIKARI_Network :)", buttons=[Button.url("🎯CHANNEL🎯", url=f"https://t.me/{channel}"), Button.url("💐REPOSITORY💐", url="https://github.com/ShikariBaaZ/ForceSub_Bot")])
